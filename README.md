...
2. **Install dependencies (If any, this will be necessary once we start adding a backend). You can skip this for now**
...
- Create a branch for your changes, preferrably from main : `git checkout -b feat/<branch-name>`
- Commit small, focused changes with clear messages
- Push your changes to your branch
- Open a pull request into `main` and request a review from another teammate
